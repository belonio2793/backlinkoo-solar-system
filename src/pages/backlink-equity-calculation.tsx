...
const BacklinkEquityCalculation: React.FC = () => {
  ...
  const htmlContent = `
    ...
    <div class="media">
        <img src="https://images.unsplash.com/photo-1460925895917-adf4e566c72f?w=800&h=400&fit=crop" alt="case study graphs for backlink equity" width="800" height="400" />
