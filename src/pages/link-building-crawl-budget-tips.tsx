...
export default function LinkBuildingCrawlBudgetTips() {
  React.useEffect(() => {
    ...
    injectJSONLD('link-building-crawl-budget-tips-schema', {
      ...
      description: `Master link building crawl budget tips with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
