...
const HowToIncreaseCrawlDemand: React.FC = () => {
  ...
  const htmlContent = `    <h1>How to Increase Crawl Demand: Get More Googlebot Visits and Indexing</h1>
    ...
    <div class="media">
      <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&h=400&fit=crop" alt="How to Increase Crawl Demand strategy" width="800" height="400" />
