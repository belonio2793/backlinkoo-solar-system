...
export default function LinkBuildingClusterContent() {
  React.useEffect(() => {
    ...
    injectJSONLD('link-building-cluster-content-schema', {
      ...
      description: `Master cluster content strategy with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
