...
export default function LinkBuildingContentPillarPages() {
  React.useEffect(() => {
    ...
    injectJSONLD('link-building-content-pillar-pages-schema', {
      ...
      description: `Master pillar pages with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
