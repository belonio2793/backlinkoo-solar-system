...
const ArePaidBacklinksWorthIt: React.FC = () => {
  ...
  const htmlContent = `
    ...
    <div class="media">
        <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&h=400&fit=crop" alt="Pros and cons of paid backlinks chart" width="800" height="400" />
