...
const ArePaidBacklinksWorthIt: React.FC = () => {
  ...
  <div class="media">
    <img src="https://images.unsplash.com/photo-1460925895917-adf4e565db18?w=800&h=400&fit=crop" alt="ROI tracking and metrics" width="800" height="400" />
    <p><em>ROI tracking and metrics (Source: Backlinkoo)</em></p>
  </div>
