...
export default function BacklinkWakeletCollection() {
  React.useEffect(() => {
    ...
    injectJSONLD('backlink-wakelet-collection-schema', {
      ...
      description: `Master backlink wakelet collection with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
