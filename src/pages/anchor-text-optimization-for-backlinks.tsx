...
const AnchorTextOptimizationForBacklinks: React.FC = () => {
  ...
  const htmlContent = `
    ...
    <div class="media">
        <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&h=400&fit=crop" alt="anchor text optimization for backlinks infographic" width="800" height="400" />
    ...
    <div class="media">
        <img src="https://images.unsplash.com/photo-1516534775068-bb57e39c568f?w=800&h=400&fit=crop" alt="Tools for backlink optimization chart" width="800" height="400" />
