...
export default function LinkBuildingPeopleAlsoAsk() {
  React.useEffect(() => {
    ...
    injectJSONLD('link-building-people-also-ask-schema', {
      ...
      description: `Master link building people also ask with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
