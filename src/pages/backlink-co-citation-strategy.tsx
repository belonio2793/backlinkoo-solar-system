...
export default function BacklinkCoCitationStrategy() {
  React.useEffect(() => {
    ...
    injectJSONLD('backlink-co-citation-strategy-schema', {
      ...
      description: `Master co-citation strategy with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
