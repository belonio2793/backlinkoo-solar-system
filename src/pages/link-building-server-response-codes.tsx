...
function upsertCanonical(typeof window !== 'undefined' ? `https://backlinkoo.com/${window.location.pathname}` : 'https://backlinkoo.com/link-building-server-response-codes') {
  if (typeof document === 'undefined') return;
