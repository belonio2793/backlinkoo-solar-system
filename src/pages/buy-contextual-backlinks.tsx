...
const BuyContextualBacklinks: React.FC = () => {
  ...
  const htmlContent = `
    ...
    <div class="media">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/BXp6pVW6zVc" title="Contextual Link Insertion Service" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="max-width: 100%;"></iframe>
      </div>
    ...
    <p>At Backlinkoo, we integrate tools like <Link to="/senuke">SENUKE</Link> and <Link to="/xrumer">XRumer</Link> into our services for efficient, high-quality link building.</p>
