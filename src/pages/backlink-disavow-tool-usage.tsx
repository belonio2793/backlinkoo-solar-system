...
const BacklinkDisavowToolUsage: React.FC = () => {
  ...
  <div class="media">
    <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&h=400&fit=crop" alt="Link quality management" width="800" height="400" />
    <p><em>Link quality management (Source: Backlinkoo)</em></p>
  </div>

  <div class="media">
    <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop" alt="Harmful link removal process" width="800" height="400" />
