...
const OnPageSeoForLinkAcquisition: React.FC = () => {
  ...
  const htmlContent = `
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/LT0dFDx0vLQ" title="Link building tutorial" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="max-width: 100%;"></iframe>
