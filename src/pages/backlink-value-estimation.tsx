...
export default function BacklinkValueEstimation() {
  React.useEffect(() => {
    ...
    injectJSONLD('backlink-value-estimation-schema', {
      ...
      description: `Master backlink value estimation with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
