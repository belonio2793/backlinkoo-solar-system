...
export default function BacklinkCollaborationIdeas() {
  React.useEffect(() => {
    ...
    injectJSONLD('backlink-collaboration-ideas-schema', {
      ...
      description: `Master backlink collaboration with our comprehensive guide. Learn proven strategies, tools, and best practices to boost your SEO rankings and acquire high-quality backlinks in 2025.`,
