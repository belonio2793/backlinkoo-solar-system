  ...
  const htmlContent = `    <h1>Backlink Diversity Services: Build Natural, Varied Link Profiles Fast</h1>
    ...
    <div class="related-links" style="margin: 20px 0; padding: 15px; background-color: #f9f9f9; border-left: 4px solid #007bff; border-radius: 4px;">
      ...
      <ul style="margin: 0; padding-left: 20px;">
        <li style="margin: 8px 0;"><a href="/mixed-backlink-packages" title="Mixed Backlink Packages">Mixed Backlink Packages</a></li>
      </ul>
    </div>
    ...
    <div class="media">
    <img src="https://images.unsplash.com/photo-1460925895917-adf4e565db18?w=800&h=400&fit=crop" alt="Link variety strategy" width="800" height="400" />
    <p><em>Link variety strategy (Source: Backlinkoo)</em></p>
  </div>
