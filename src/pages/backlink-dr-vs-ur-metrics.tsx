...
const BacklinkDrVsUrMetrics: React.FC = () => {
  ...
  <div class="media">
    <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&h=400&fit=crop" alt="Domain authority metrics" width="800" height="400" />
    <p><em>Domain authority metrics (Source: Backlinkoo)</em></p>
  </div>

  <div class="media">
    <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop" alt="SEO rating systems" width="800" height="400" />
