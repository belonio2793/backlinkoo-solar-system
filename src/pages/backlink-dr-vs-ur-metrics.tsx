...
const BacklinkDrVsUrMetrics: React.FC = () => {
  ...
  <div class="media">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/qJTRZ_MXV_c" title="Understanding Domain Authority vs Page Authority" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="max-width: 100%;"></iframe>
      </div>
