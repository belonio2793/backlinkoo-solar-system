...
const BacklinksForServiceBusinesses: React.FC = () => {
  ...
  const htmlContent = `    <h1>Backlinks for Service Businesses: Local Authority and Client Attraction</h1>
    ...
    <div class="media">
      <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=400&fit=crop" alt="Backlinks for Service Businesses strategy" width="800" height="400" />
