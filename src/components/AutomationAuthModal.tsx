...
interface AutomationAuthModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  campaignData?: {
...
const AutomationAuthModal = ({ isOpen, onClose, onSuccess, campaignData }: AutomationAuthModalProps) => {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {campaignData && (
          <div className="bg-blue-50 p-3 rounded-lg mb-4">
            <h4 className="font-medium text-blue-900 mb-1">Campaign Details:</h4>
...
export default AutomationAuthModal;
