...
const LazyEnhancedAdminOverview = lazy(() => import('@/components/admin/EnhancedAdminOverview').then(m => ({ default: m.EnhancedAdminOverview })));
const LazyComprehensiveUserManagement = lazy(() => import('@/components/admin/ComprehensiveUserManagement').then(m => ({ default: m.default })));
const LazyAdminCampaignsManagement = lazy(() => import('@/components/admin/AdminCampaignsManagement').then(m => ({ default: m.default })));
const LazyEmailSystemManagerSafe = lazy(() => import('@/components/admin/EmailSystemManagerSafe').then(m => ({ default: m.EmailSystemManagerSafe })));
const LazySMTPConfigTest = lazy(() => import('@/components/SMTPConfigTest').then(m => ({ default: m.SMTPConfigTest })));
const LazyEmailConfigurationTester = lazy(() => import('@/components/EmailConfigurationTester').then(m => ({ default: m.default })));
const LazyAuthEmailTest = lazy(() => import('@/components/AuthEmailTest').then(m => ({ default: m.AuthEmailTest })));
const LazyEmailTest = lazy(() => import('@/components/EmailTest').then(m => ({ default: m.EmailTest })));
const LazySupabaseEmailTest = lazy(() => import('@/components/SupabaseEmailTest').then(m => ({ default: m.SupabaseEmailTest })));
const LazySupabaseEmailGuide = lazy(() => import('@/components/SupabaseEmailGuide').then(m => ({ default: m.SupabaseEmailGuide })));
const LazyCampaignManager = lazy(() => import('@/components/CampaignManager').then(m => ({ default: m.default })));
const LazyPlatformProgressFixer = lazy(() => import('@/components/debug/PlatformProgressFixer').then(m => ({ default: m.default })));
const LazyMissingColumnsFix = lazy(() => import('@/components/system/MissingColumnsFix').then(m => ({ default: m.MissingColumnsFix })));
const LazyCampaignMetricsDBVerifier = lazy(() => import('@/components/CampaignMetricsDBVerifier').then(m => ({ default: m.default })));
const LazyDatabaseTestComponent = lazy(() => import('@/components/DatabaseTestComponent').then(m => ({ default: m.DatabaseTestComponent })));
const LazyDeploymentStatus = lazy(() => import('@/components/DeploymentStatus').then(m => ({ default: m.DeploymentStatus })));
const LazyFullStoryTestComponent = lazy(() => import('@/components/FullStoryTestComponent').then(m => ({ default: m.default })));
const LazyServiceConnectionStatus = lazy(() => import('@/components/admin/ServiceConnectionStatus').then(m => ({ default: m.ServiceConnectionStatus })));
const LazyGlobalNotificationsTester = lazy(() => import('@/components/admin/GlobalNotificationsTester').then(m => ({ default: m.GlobalNotificationsTester })));
const LazyTextCleanerControls = lazy(() => import('@/components/admin/TextCleanerControls').then(m => ({ default: m.TextCleanerControls })));
const LazyAdminBlogManager = lazy(() => import('@/components/admin/AdminBlogManager').then(m => ({ default: m.AdminBlogManager })));
const LazyBlogManagementPanel = lazy(() => import('@/components/admin/BlogManagementPanel').then(m => ({ default: m.BlogManagementPanel })));
const LazyContentFilterManager = lazy(() => import('@/components/admin/ContentFilterManager').then(m => ({ default: m.ContentFilterManager })));
const LazyContentModerationQueue = lazy(() => import('@/components/admin/ContentModerationQueue').then(m => ({ default: m.ContentModerationQueue })));
const LazyAIPostsManager = lazy(() => import('@/components/admin/AIPostsManager').then(m => ({ default: m.AIPostsManager })));
const LazyBlogPostClaimsManager = lazy(() => import('@/components/admin/BlogPostClaimsManager').then(m => ({ default: m.BlogPostClaimsManager })));
const LazyBlogSystemAdmin = lazy(() => import('@/components/admin/BlogSystemAdmin').then(m => ({ default: m.BlogSystemAdmin })));
const LazyTrialPostCleanupManager = lazy(() => import('@/components/admin/TrialPostCleanupManager').then(m => ({ default: m.TrialPostCleanupManager })));
const LazySystemsAssessmentDashboard = lazy(() => import('@/components/admin/SystemsAssessmentDashboard').then(m => ({ default: m.SystemsAssessmentDashboard })));
const LazyNetlifyEnvironmentManager = lazy(() => import('@/components/admin/NetlifyEnvironmentManager').then(m => ({ default: m.NetlifyEnvironmentManager })));
const LazyNetlifyAliasPurger = lazy(() => import('@/components/admin/NetlifyAliasPurger'));
