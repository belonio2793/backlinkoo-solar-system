...
function extractPageData(fileContent) {
...
function generateConvertedPage(pageName, data) {
...
const ${componentName}: React.FC = () => {
  ...
  const subtitle = "${escapeQuotes(data.subtitle)}";
  const htmlContent = \`${escapeBackticks(data.htmlContent)}\`;
