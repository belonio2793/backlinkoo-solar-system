-- ==========================================
-- CAMPAIGN METRICS DATABASE SETUP
-- ==========================================
-- Copy and paste this entire script into your Supabase SQL Editor
-- This will create all required tables, views, and functions for campaign metrics persistence
...
-- Function to update campaign runtime metrics with progressive counting
...
DECLARE
    ...
    aggregate_id UUID;
BEGIN
    -- Determine user premium status (adjust based on your user system)
    SELECT 
...
-- Campaign runtime metrics indexes
...
-- SETUP COMPLETE! 
-- ==========================================
-- Your campaign metrics database is now ready.
-- 
-- What this creates:
...
-- ✅ live_campaign_monitor - Real-time dashboard view
-- ✅ user_dashboard_summary - User overview view
-- ✅ update functions - Automatic data management
-- ✅ RLS policies - Secure user data access
-- ✅ Performance indexes - Fast query execution
--
-- Your campaign reporting will now persist indefinitely! 🎯
